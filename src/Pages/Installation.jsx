...
const Installation = () => {
    ...
    const handleRemove = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                localStorage.removeItem(`installed${id}`)
    ...
    return (
        <div>
            {
                installedList.length === 0 ? <div className='flex flex-col justify-center items-center gap-5'>
                    <h2 className='text-4xl font-bold'>No apps found!</h2>
                    <p className='text-xl text-gray-950 font-semibold'>Install your favorite app</p>
